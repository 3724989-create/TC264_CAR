...
code/pid/self_pid.src: ../code/pid/self_pid.c code/pid/subdir.mk
...
code/pid/self_pid.o: code/pid/self_pid.src code/pid/subdir.mk
	astc -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"

clean: clean-code-2f-pid

clean-code-2f-pid:
	-$(RM) code/pid/self_pid.d code/pid/self_pid.o code/pid/self_pid.src
