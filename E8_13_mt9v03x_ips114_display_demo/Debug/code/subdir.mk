...
code/Self_mtv90x.o: code/Self_mtv90x.src code/subdir.mk
	astc -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"
code/self_math.src: ../code/self_math.c code/subdir.mk
	cctc -cs --dep-file="$(*F).d" --misrac-version=2004 -D__CPU__=tc26xb "-fD:/TC264_p/TC264_CAR/E8_13_mt9v03x_ips114_display_demo/Debug/TASKING_C_C___Compiler-Include_paths__-I_.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc26xb -Y0 -N0 -Z0 -o "$@" "$<"
code/self_math.o: code/self_math.src code/subdir.mk
	astc -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"

clean: clean-code

clean-code:
	-$(RM) code/Self_BSP.d code/Self_BSP.o code/Self_BSP.src code/Self_Motor.d code/Self_Motor.o code/Self_Motor.src code/Self_Servo.d code/Self_Servo.o code/Self_Servo.src code/Self_mtv90x.d code/Self_mtv90x.o code/Self_mtv90x.src code/self_math.d code/self_math.o code/self_math.src
