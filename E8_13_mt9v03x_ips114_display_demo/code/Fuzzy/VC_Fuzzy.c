...
float rule_double_im[7][7] = {
    /*EC (偏差变化率)*/
    /*0-6 (偏差E的模糊子集)*/  {-100, -100, -80, -80, -60, -20, -20,},
...
//-------------------------------------------------------------------------------------------------------------------
//  @brief      双边模糊 (Two-sided Fuzzy Logic)
//  @param      *PFF_double   纵轴输入论域
...
//-------------------------------------------------------------------------------------------------------------------
//  @brief      单边模糊 (One-sided Fuzzy Logic)
//  @param      *PFF_single   纵轴输入论域
